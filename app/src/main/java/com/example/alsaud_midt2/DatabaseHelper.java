...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_PHONE = "surname";
    public static final String COLUMN_EMAIL = "national id number";
    ...
    public boolean addStudent(int id, String name, int phone, String email){
        ...
        values.put(COLUMN_PHONE, surname);
        values.put(COLUMN_EMAIL, national id number);
